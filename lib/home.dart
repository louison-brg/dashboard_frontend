...
class _HomeState extends State<Home> with SingleTickerProviderStateMixin {
  ...
  int screenIndex = ScreenSelected.dashboard.value;
  ...
  Widget createScreenFor(
      ...
      switch (screenSelected) {
        ScreenSelected.dashboard => Expanded(
          child : ComponentList(
              showNavBottomBar: showNavBarExample,
              scaffoldKey: scaffoldKey)

        ),
        //AJOUTER LES NOUVELLES PAGES AU BESOIN ICI
      };
  ...
  PreferredSizeWidget createAppBar() {
    return AppBar(
      title: const Row(
        children: [
          Text('Y O U T U B E  D A T A  E X P L O R E R'),
          Expanded(
        ...
        return NavigationTransition(
          ...
          navigationRail: NavigationRail(
            ...
            onDestinationSelected: (index) {
              setState(() {
                screenIndex = index;
                //METTRE ICI LES ACTION DE LA BAR SUR LE COTE
